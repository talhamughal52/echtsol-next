  ...
  return (
    <footer className="sc-4443778d-0 jOCBEB mobileDissapear">
      <div className="sc-4443778d-1 bOAiWr">
        <Link href="/" className="sc-4443778d-5 ePuuSX">
          <div className="sc-bf71e4fb-0 bshMkq footer">
        ...
        <div className="sc-4443778d-11 jdVMmI">
          <div className="sc-4443778d-12 hgOKiV">
            <a href="#" className="sc-4443778d-3 elugKM">
              <svg
                width="100%"
                height="100%"
                viewBox="0 0 27 19"
                ...
                className="sc-4443778d-8 iWQtVn scrolled"
              >
              ...
              <span className="sc-4443778d-4 cONLua">contact@cgsteam.io</span>
              <div className="sc-4443778d-2 gWcWVJ">
            ...
            <a href="#" className="sc-4443778d-3 elugKM">
              ...
              <span className="sc-4443778d-4 cONLua">hr@cgsteam.io</span>
              <div className="sc-4443778d-2 gWcWVJ">
                If you want to become our colleague
              </div>
            </a>
          </div>
          <Link href="/privacy-policy" className="sc-4443778d-10 XGbmr">
            Privacy Policy
          </Link>
        </div>
      </div>
          ...
          <div className="sc-4443778d-9 hplPmR">
            <span className="footerNavIconsSpan">
              <Image
                ...
                srcSet="
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg  640w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg  750w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg  828w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg 1080w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg 1200w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg 1920w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg 2048w,
                  https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg 3840w"
                src="https://d2qrnmx3qcgrup.cloudfront.net/d4dc5240-ac91-461b-9ddd-ef9ffeb93c1a.svg"
